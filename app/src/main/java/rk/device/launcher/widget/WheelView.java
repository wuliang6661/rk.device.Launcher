...
public class WheelView extends View {
    ...
    private List<String> mAlterTextArrayWithMeasureHint;
    private List<String> mAlterTextArrayWithoutMeasureHint;
    ...
    public interface OnValueChangeListenerRelativeToRaw{
        void onValueChangeRelativeToRaw(WheelView picker, int oldPickedIndex, int newPickedIndex, List<String> displayedValues);
    }
    ...
    private void initAttr(Context context, AttributeSet attrs){
        ...
        for (int i = 0; i < n; i++) {
            ...
            if(attr == R.styleable.WheelView_npv_ShowCount){
                ...
                mAlterTextArrayWithMeasureHint = convertCharSequenceArrayToStringArray(a.getTextArray(attr));
            }else if(attr == R.styleable.WheelView_npv_AlternativeTextArrayWithoutMeasureHint){
                mAlterTextArrayWithoutMeasureHint = convertCharSequenceArrayToStringArray(a.getTextArray(attr));
            }
        }
        a.recycle();
    }
    ...
    public void setDisplayedValuesAndPickedIndex(List<String> newDisplayedValues, int pickedIndex, boolean needRefresh){
        stopScrolling();
    ...
    public void setDisplayedValues(List<String> newDisplayedValues, boolean needRefresh){
     ...
     */
    public void refreshByNewDisplayedValues(List<String> display) {
    ...
    private void drawContent(Canvas canvas){
        ...
        for(int i = 0; i < mShowCount + 1; i++){
            ...
            if(0 <= index && index < getOneRecycleSize()){
                canvas.drawText(mDisplayedValues.get(index + mMinShowIndex).toString(), mViewCenterX,
    ...
    private int getMaxWidthOfTextArray(List<String> array, Paint paint){
        if(array == null){
            return 0;
        }
        int maxWidth = 0;
    ...
    private void updateContentAndIndex(List<String> newDisplayedValues){
        mMinShowIndex = 0;
    ...
    private void updateContent(List<String> newDisplayedValues){
        mDisplayedValues = newDisplayedValues;
        updateWrapStateByContent();
    }
    ...
    private void inflateDisplayedValuesIfNull(){
        if(mDisplayedValues == null) {
            ...
            mDisplayedValues.add("0");
        }
    }

    private void updateWrapStateByContent(){
        mWrapSelectorWheelCheck = mDisplayedValues.size() <= mShowCount ? false : true;
    }
	...
	private List<String> convertCharSequenceArrayToStringArray(CharSequence[] charSequences){
