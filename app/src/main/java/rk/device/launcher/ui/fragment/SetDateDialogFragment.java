...
public class SetDateDialogFragment extends BaseDialogFragment {
     ...
     * @return
     */
    public static SetDateDialogFragment newInstance() {
        SetDateDialogFragment wheelDialog = new SetDateDialogFragment();
...
//		getDialog().getWindow().setLayout(ScreenUtil.getScreenWidth(activity), getDialog().getWindow().getAttributes().height);
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		View view = inflater.inflate(R.layout.view_dialog_set_date, container, false);
...
//		setStyle(DialogFragment.STYLE_NO_TITLE, R.style.dialog);
	...
	private void initEvent() {
		...
		mTvCancel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				SetDateDialogFragment.this.dismiss();
			}
		});
		...
		mTvConfirm.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (mOnConfirmDialogListener != null) {
					mOnConfirmDialogListener.onClickConfirm(mWheelViewYear.getValue(), mWheelViewMonth.getValue(), mWheelViewDay.getValue());
					SetDateDialogFragment.this.dismiss();
				}
			}
		});
	...
	public interface OnConfirmDialogListener {
		void onClickConfirm(String year, String month, String day);
	}
