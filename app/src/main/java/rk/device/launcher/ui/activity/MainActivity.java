...
public class MainActivity extends BaseCompatActivity implements View.OnClickListener {
	...
	TextView mTvDeclare;
	@Bind(R.id.rl_contact_manager)
	RelativeLayout mRlContactManager;
	...
	public void initView() {
		...
		setOnClick(R.id.rl_contact_manager);
	...
	protected void onResume() {
		super.onResume();
		mTvPlaceName.setText(SPUtils.getString(Constant.DEVICE_NAME));
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.rl_contact_manager:
				if (!TextUtils.isEmpty(mobiePhone)) {
					showMessageDialog("联系电话:" + mobiePhone);
				}
				break;
		}
	}
