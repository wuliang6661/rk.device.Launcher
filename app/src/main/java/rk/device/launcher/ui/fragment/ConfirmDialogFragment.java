...
//		unbinder.unbind();
	...
	public ConfirmDialogFragment setOnCancelClickListener(onCancelClickListener onCancelClickListener) {
		mOnCancelClickListener = onCancelClickListener;
		return this;
	}

	public ConfirmDialogFragment setOnConfirmClickListener(OnConfirmClickListener onConfirmClickListener) {
...
//		decorView.setPadding(100, 0, 100, 0);
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.dialogfragment_confirm, container, false);
		//设置窗口以对话框样式显示
